...
const Banner = () => {
	return (
		<section
			className='min-h-[85vh] lg:min-h-[78vh] flex items-center px-5'
			id='home'
		>
				...
				<div className='flex justify-center flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12 '>
					<div className='flex-1 justify-start text-center font-secondary lg:text-left'>
						<motion.h1
							...
							className='font-bold leading-[0.8] text-[80px] lg:text-[110px]'
						>
							LOHITH
						</motion.h1>
						<motion.div
						...
						>
							Experienced Full Stack and Android developer, creating engaging
							solutions. Proficient in various technologies, dedicated to
							crafting innovative experiences that leave a lasting impact.
						</motion.p>
						<motion.div
