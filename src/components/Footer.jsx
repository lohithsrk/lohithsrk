		...
		<div className='bg-tertiary p-5 pb-0 w-full  bg-white/10 backdrop-blur-md flex items-center justify-center flex-col'>
			<div className='container flex  items-center justify-center pb-0 flex-col'>
				<div className='container flex justify-between items-center flex-col md:flex-row'>
					...
					<div className='flex text-[20px]  items-center md:flex-row flex-col-reverse'>
						<div className='flex gap-x-6 mr-5'>
							<a
								href='https://github.com/lohithsrk'
								target='_blank'
							...
							<a
								href='https://www.linkedin.com/in/lohith2003'
								target='_blank'
								className='cursor-pointer'
								rel='noreferrer'
							>
							...
							<a
								href='mailto:srklohith05@gmail.com'
								target='_blank'
								className='cursor-pointer'
								rel='noreferrer'
							>
						...
						<div className='flex gap-x-3 my-2 md:my-0 md:ml-4'>
							<a
								...
								smooth={true}
								offset={-200}
								className='cursor-pointer font-primary !p-0 hover:footer-text-gradient transition-all text-xs  hover:!text-xs flex items-center justify-center'
							>
								Home{' '}
							</a>
							<a
								href='#about'
								smooth={true}
								className='cursor-pointer font-primary !p-0 hover:footer-text-gradient text-xs hover:!text-xs transition-all  flex items-center justify-center'
							>
								About{' '}
							</a>
							<a
				...
				<p className='text-white/50 text-sm mb-2 mt-3'>
					Copyright © Lohith.pro. All rights reserved.
				</p>
			</div>
		</div>
	);
